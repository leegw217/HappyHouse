...
public class PageNavigation {
	...
	public void makeNavigator() {
		...
		System.out.println(currentPage+" "+totalPageCount);
		...
		buffer.append("				<a href=\"#\" class=\"page-link\">맨 앞</a> \n");
		buffer.append("			</li> \n");
		...
		for(int i=startPage;i<=endPage;i++) {
			if(i == currentPage) {
				buffer.append("			<li class=\"" + "page-item active" + "\" data-pg=\"" + i + "\"><a href=\"#1\" class=\"page-link\">" + i + "</a></li> \n");				
			} else {
			buffer.append("			<li class=\"" + "page-item" + "\" data-pg=\"" + i + "\"><a href=\"#${i}\" class=\"page-link\">" + i + "</a></li> \n");
			}
		}
