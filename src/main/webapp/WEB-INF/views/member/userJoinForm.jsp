...
<body>
	...
	<form style="text-align: center;" method="post" action="${root}/user/join" id="joinForm">
	  	<fieldset>
          	<legend style="padding-top: 50px; font-size: 40px;">회원가입</legend>
          	...
          	<div class="form">
              	<label for="pw" class="label--right"><span class="text-warning">*</span>Password : </label>
              	<input type="password" name="pw" id="pw" class="wt100" placeholder="At least 6 letters or numbers">
          	</div>
          	<div class="form">
              	<label for="vpassword" class="label--right"><span class="text-warning">*</span>Verify Password : </label>
              	<input type="password" name="vpassword" id="vpassword" class="wt100" placeholder="Confirm Password">
          	</div>
          	<div class="form">
          	...
          	<div class="form">
              	<label for="email" class="label--right">E-Mail : </label>
              	<input type="text" name="email" id="email" class="wt100" placeholder="Email">
          	</div>
          	<div class="form">
              	<label for="address" class="label--right">Address : </label>
              	<input type="text" name="address" id="address" class="wt100" placeholder="Code">
          	</div>
          	<div class="form">
              	<!-- <label for="grade" class="label--right">Grade : </label> -->
              	<input type="hidden" class="wt100" id="grade" type="text" name="grade" value="1">
          	</div>
