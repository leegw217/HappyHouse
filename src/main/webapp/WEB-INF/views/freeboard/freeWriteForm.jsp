...
<body>
	<div id="wrap">
	    ...
	    <div class="innermain" style="height:850px;">
			<h1 style="text-align:center; padding-top:20px;">게시글 작성</h1><br>
			<form id="freeForm" method="post" action="${root}/freeboard/freewrite">
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<button type="button" class="btn-secondary" onclick="location.href='${root}/freeboard/freelist'">목록</button>
					</div>
				</div>
			</form>
		</div>
