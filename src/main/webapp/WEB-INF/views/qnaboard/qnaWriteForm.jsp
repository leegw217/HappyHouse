...
<body>
	<div id="wrap">
	    ...
	    <div class="innermain" style="height:850px;">
			<h1 style="text-align:center; padding-top:20px;">QnA 게시글 작성</h1><br>
			<form id="qnaForm" method="post" action="${root}/qnaboard/qnawrite">
				...
				<table class="boarddetail">
					...
					<tr>
						<th>비밀글</th>
						<td><input class="form-check-input" type="checkbox" id="gridCheck1" name="secret"></td>
					</tr>
				</table>
				...
				<div class="form-group row">
					...
					<div class="col-sm-10">
						...
						<button type="button" class="btn-secondary" onclick="location.href='${root}/qnaboard/qnalist'">목록</button>
					</div>
				</div>
			</form>
		</div>
